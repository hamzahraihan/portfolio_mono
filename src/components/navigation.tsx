...
function Navigation() {
  ...
  return (
    <div className="flex justify-between items-center border-b dark:border-neutral-800 text-sm h-10 mx-4">
      <div>hamzahraihan</div>
      <Switch onClick={() => setTheme(theme == 'dark' ? 'light' : 'dark')} checked={theme != 'dark'} aria-readonly />
